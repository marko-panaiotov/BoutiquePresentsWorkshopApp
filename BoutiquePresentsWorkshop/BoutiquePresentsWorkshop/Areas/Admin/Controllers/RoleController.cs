...
using BoutiquePresentsWorkshop.Areas.Admin.Models;
...
namespace BoutiquePresentsWorkshop.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult>Create(string name)
        {
            ...
            if(isExist)
            {
                ViewBag.mgs = "Ролята вече съществува!";
                ViewBag.name = name;
                return View();
            }
            ...
            if(result.Succeeded)
            {
                TempData["save"] = "Ролята е запазена успешно!";
        ...
        public async Task<IActionResult> Edit(string id,string name)
        {
            ...
            if (result.Succeeded)
            {
                TempData["save"] = "Ролята е редактирана успешно";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
        ...
        public async Task<IActionResult>DeleteConfirm(string id)
        {
            ...
            if(result.Succeeded)
            {
                TempData["delete"] = "Ролята е изтрита успешно";
                return RedirectToAction(nameof(Index));
            }            
            return View();
        }
        ...
        public async Task<IActionResult> Assign(RoleUserVm roleUser)
        {
            ...
            {
                ViewBag.mgs = "Потребителя вече е с тази роля.";
                ViewData["UserId"] = new SelectList(_db.ApplicationUsers.Where(f => f.LockoutEnd < DateTime.Now || f.LockoutEnd == null).ToList(), "Id", "UserName");
                ViewData["RoleId"] = new SelectList(_roleManager.Roles.ToList(), "Name", "Name");
                return View();
            }
            ...
            if(role.Succeeded)
            {
                TempData["save"] = "Ролята е зададена.";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
