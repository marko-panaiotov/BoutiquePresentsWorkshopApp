    ...
    public class SpecialTagController : Controller
    {
        ...
        public async Task<IActionResult> Create(SpecialTag specialTag)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["save"] = "Типа на изработка е добавен успешно!";
        ...
        public async Task<IActionResult> Edit(SpecialTag specialTag)
        {
            if (ModelState.IsValid)
            {
                ...
                await _db.SaveChangesAsync();
                TempData["edit"] = "Типа на изработка е редактиран успешно!";
                return RedirectToAction(nameof(Index));
            }
        ...
        public async Task<IActionResult> Delete(int? id, SpecialTag specialTag)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _db.SaveChangesAsync();
                TempData["delete"] = "Типът на изработка е премахнат успешно!";
                return RedirectToAction(nameof(Index));
            }
